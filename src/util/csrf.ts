...
export function generateNonce() {
	const randomString = generateSecret(CSRF_CONFIG.secretAllowedCharacters, CSRF_CONFIG.nonceLength)
...
export function generatePkceVerifier() {
	const pkce = generateSecret(CSRF_CONFIG.secretAllowedCharacters, CSRF_CONFIG.pkceLength)
	const verifier = {
		pkce,
